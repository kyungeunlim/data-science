...
def create_df_from_bq(query_txt:str,
                      project_number = "483511207379",
                      project_id = "cloudtrucks-production") -> pd.DataFrame:
    """
    Args:
        1. query_txt: SQL query as str  
        2. project_number: Project number, default is set as 'cloudtrucks-production'
...
def create_df_from_gcs_file(blob_name:str, 
                            ...
                            b_stand_cols = True,                            
                            project_number = "483511207379",
                            bucket_name = "data-science-cloudtrucks-production", 
                            ) -> pd.DataFrame:
    """
    Args: 
        ...
        7. bucket_name: gcp bucket, default is "data-science-cloudtrucks-production"
...
def load_bq_table_from_df(df:pd.DataFrame,
                          ds_table_name = "us_contract_rfp.raw_test_ds",
                          project_name = "cloudtrucks-production",
                         ) -> None:
    """
...
def upload_file_to_gcs(local_filename:str,
    ...
    Args:
        ...
        3. bucket_name: default bucket is "data-science-cloudtrucks-production"
